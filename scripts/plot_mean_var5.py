...
N = 138
FILE1 = '/home/dvij/intro_to_rl/16831_F23_HW/safety-starter-agents/data/2023-10-08_ppo_lagrangian_PointPush1/2023-10-08_13-24-32-ppo_lagrangian_PointPush1_s0/progress.txt'
...
FILE2 = '/home/dvij/intro_to_rl/16831_F23_HW/safety-starter-agents/data/2023-10-08_ppo_lagrangian_PointPush1/2023-10-08_04-06-44-ppo_lagrangian_PointPush1_s0/progress.txt'
...
FILE = '/home/dvij/intro_to_rl/16831_F23_HW/safety-starter-agents/data/2023-10-09_ppo_PointPush1/2023-10-09_22-02-20-ppo_PointPush1_s0/progress.txt'
...
ax.plot([2700000,2700000],[-5.,10.],color='purple',label='t_start')
ax.plot([3400000,3400000],[-5.,10.],color='brown',label='t_end')
plt.ticklabel_format(style='sci', axis='x', scilimits=(0,0))
plt.xlabel('n_steps')
plt.ylabel('rewards')
plt.title('n_steps vs rewards')
plt.legend()
plt.savefig('rewards4.png')
plt.show()
